<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="privacity.aspx.cs" Inherits="DID2.privacity" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h2>Política Privacidade</h2>
    <p>A sua privacidade é importante para nós. É política do Documents in Drawer respeitar a sua privacidade em relação
        a qualquer informação sua que possamos coletar no site <a href=http://localhost:3000/privacity>Documents in
            Drawer</a>, e outros sites que possuímos e operamos.</p>
    ...
    <h2>Política de Cookies Documents in Drawer</h2>
    ...
    <p>O usuário se compromete a fazer uso adequado dos conteúdos e da informação que o Documents in Drawer oferece no
    ...
    <ul>
        ...
        <li>B) Não difundir propaganda ou conteúdo de natureza racista, xenofóbica, <a
            ...
            humanos;</li>
        <li>C) Não causar danos aos sistemas físicos (hardwares) e lógicos (softwares) do Documents in Drawer, de seus
